...
let songIndex = 0;
let audioElement = new Audio('C:\Computing\Codes\Spotify-Clone-main\Spotify-Clone-main\songs');
...
const initializeSongItems = () => {
    songItems.forEach((element, i) => {
        element.getElementsByTagName("C:\Computing\Codes\Spotify-Clone-main\Spotify-Clone-main\covers")[0].src = songs[i].coverPath;
